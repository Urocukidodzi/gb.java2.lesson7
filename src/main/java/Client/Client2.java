                    ...
                    while (true) {
                        ...
                        if (serverMessege.startsWith("/")) {
                            if (serverMessege.startsWith("/authok")) {
                                Client2.Windows.text = Client2.Windows.text.concat("Welcome to the CHAT" + "\n");
                                Client2.Windows.setInArea();
...
//                                System.out.println(serverMessege);
                            ...
                            Client2.Windows.text = Client2.Windows.text.concat("[" + Client2.Windows.date() + "]" + serverMessege + "\n");
                            Client2.Windows.setInArea();
                        }
                    }
                } catch (IOException e) {
    ...
    static class Windows extends JFrame {
        ...
        public Windows(String name, Client2 client) {
            this.client = client;
            this.name = name;
